...
<div class="card-front">
	<div class="text-container">
		<div class="content">
			...
			<p class="support">
				I created this app and pay for server time, so help me keep it running with a small donation
				($5 recommended, but I'll be happy with anything, thank you!).
			</p>
			<div class="payment-options">
				<a
					href="https://venmo.com/CodesAgainstAcademy?txn=pay&amount=5&note=Full Digital Deck"
					target="_blank"
					rel="noopener noreferrer"
					class="payment-button venmo">Venmo</a
				>
				<a
					href="https://paypal.me/JoshuaLake/5"
					target="_blank"
					rel="noopener noreferrer"
					class="payment-button paypal">PayPal</a
				>
				<a
					href="https://cash.app/$rootlake"
					target="_blank"
					rel="noopener noreferrer"
					class="payment-button cashapp">Cash App</a
				>
			</div>
			<p class="student-note">
				If the cost is prohibitive or you're a student, send me an email at <a
					href="mailto:jlake@pomfret.org"
					class="email-link">jlake@pomfret.org</a
				> to request an unlock code.
			</p>
			{#if !showCodeInput}
				<button class="code-button" on:click={() => (showCodeInput = true)}> Enter Code </button>
			{:else}
				<div class="code-input-container">
					...
					/>
					<button class="submit-button" on:click={handleUnlock}> Unlock </button>
				</div>
				{#if errorMessage}
